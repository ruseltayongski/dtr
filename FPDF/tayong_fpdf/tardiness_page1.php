<?php
    ...
    function tardiness_view($year,$month)
    {
        ...
        try {
            ...
            $st = $pdo->prepare("SELECT CAST(tardiness.tardiness_min as DECIMAL(9,2)) as tardiness_min,userid,name,position,division,section,employee_status,tardiness_day FROM tardiness where year = ? and month = ? and tardiness_day != 0 order by tardiness_day desc");
