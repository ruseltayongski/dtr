...
class createPDF {
    ...
    function __construct($_html = null,$_title = null,$_articleurl = null,$_author = null,$_date = null) {
       /* // main vars
    ...
    function run($_html = null,$_title = null,$_articleurl = null,$_author = null,$_date = null) {
        $this->html=$_html;               // html text to convert to PDF
        $this->title=$_title;             // article title
        $this->articleurl=$_articleurl;   // article URL
        $this->author=$_author;           // article author
