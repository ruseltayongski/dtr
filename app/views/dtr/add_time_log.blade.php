...
@section('content')
    <div class="col-md-12 wrapper">
        <div class="alert alert-jim">
            <h3 class="page-header">Create time log
            </h3>
            <div class="container">
                <div class="row">
                    <div class="col-md-11">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="col-md-2 form-control" id="inputEmail3" name="userid" value="{{ Auth::user()->userid}}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="inputEmail3" name="firstname" value="{{ Auth::user()->fname }}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="inputEmail3" name="lastname" value="{{ Auth::user()->lname }}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
