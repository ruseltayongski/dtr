    ...
    @if($info->doc_type == "TIME_OFF")
        <table class="table table-hover table-striped table-info">
            <tr>
                ...
                <td class="col-sm-8">
                    <input type="text" class="form-control" value="{{ Auth::user()->fname }} {{ Auth::user()->lname }}" required readonly>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="col-sm-8">
                    <div class="input-group">
                        ...
                        <input class="form-control datepickercalendar" value="{{ date('m/d/Y',strtotime($info->prepared_date)) }}" name="prepared_date" <?php if($info->version == 1)echo 'required';else echo'disabled';?>>
                    </div>
                </td>
            </tr>
            <tr>
                    ...
                    <td class="col-sm-8">
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="area[]" class="form-control" rows="1" placeholder="Input your area here..." style="resize: none;width: 100%;margin-left:2%" required>{{ $row->area }}</textarea>
                            </div>
                        </div>
                    </td>
                </tr>
