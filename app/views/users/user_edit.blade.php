@if(isset($user))
    <form action="{{ asset('user/edit') }}" method="POST" id="create">
        ...
        <div class="modal-footer">
            ...
            <a href="{{ asset('mobileV3/area_of_assignment?userid='.$user->userid) }}" class="btn btn-primary" name="getArea" target="_blank" style="color: white;">
                <i class="fa fa-map-marker">&nbsp; Get MAP API</i>
            </a>
