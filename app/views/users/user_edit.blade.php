    ...
    <form action="{{ asset('user/edit') }}" method="POST" id="create">
        ...
        <div class="modal-body">
            <table class="table table-hover table-form table-striped">
                ...
                <tr>
                    <td class="col-sm-3"><label>Gliding</label></td>
                    <td class="col-sm-1">:</td>
                    <td class="col-sm-8">
                        <select name="gliding" class="form-control">
                            @if(!$user->gliding)
                                <option value="">Select option</option>
                            @endif
                            <option <?php if($user->gliding=='yes') echo 'selected'; ?> value="yes">Yes</option>
                            <option <?php if($user->gliding=='no') echo 'selected'; ?> value="no">No</option>
                        </select>
                    </td>
                </tr>
