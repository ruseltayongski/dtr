        ...
        <table class="table table-hover table-form table-striped">
            @if(Session::get('type') == "SO")
                <tr class="description_tr_desc">
                    ...
                    <td class="col-sm-8">
                        <input type="text" id="desc"  name="so" class="form-control" required placeholder="OFFICE ORDER NO. ONLY"  onkeypress="return isNumber(event)">
                    </td>
                </tr>
            @elseif(Session::get('type') == "LEAVE")
                <tr class="description_tr_leave">
                    ...
                    <td class="col-sm-1">:</td>
                    <td class="col-sm-8">
                        <select name="leave_type" id="leave_type_select"  required class="form-control" >
