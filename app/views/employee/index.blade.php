                                        ...
                                        @foreach($replies as $rep)
                                            <div class="item" style="margin-left:8%;margin-top: 1%">
                                                <div class="row">
                                                    <div class="col-md-1">
                                                        <div class="item">
                                                            <img src="{{ isset($rep->picture) ? 'https://pis.cvchd7.com/'.'public/upload_picture/picture/'.$rep->picture : 'https://pis.cvchd7.com/'.'public/upload_picture/picture/uknown.png' }}" alt="user image" class="offline">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-9">
                                                                <span href="#" class="name text-blue" style="display: inline">
