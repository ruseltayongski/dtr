                                        ...
                                        @foreach($replies as $rep)
                                            <div class="item" style="margin-left:8%;margin-top: 1%">
                                                <div class="row">
                                                    <div class="col-md-1">
                                                        <div class="item">
                                                            <img src="{{ isset($rep->picture) ? 'http://49.157.74.3/pis/'.'public/upload_picture/picture/'.$rep->picture : 'http://49.157.74.3/pis/'.'public/upload_picture/picture/uknown.png' }}" alt="user image" class="offline">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-9">
                                                                <span href="#" class="name text-blue" style="display: inline">
