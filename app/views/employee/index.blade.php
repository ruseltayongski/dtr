            ...
            <div class="box box-widget">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        New features of DTR VERSION 4.3<br> Just click here <i class="ace-icon fa fa-hand-o-right"></i> <a href="{{ asset('logs/timelogs') }}"><strong>Manage Timelog</strong></a>
                    </div>
                ...
                <div class="box-body chat" id="chat-box">
                    <form action="#" autocomplete="off">
                        <div class="row">
                            <div class="col-md-1">
                                <div class="item">
                                    <img src="{{ isset($defaultPicture->picture) ? 'https://pis7.cvchd7.com/'.'upload_picture/picture/'.InformationPersonal::where('userid','=',Auth::user()->userid)->first()->picture : 'https://pis7.cvchd7.com/'.'upload_picture/picture/uknown.png' }}"  alt="user image" class="online">
                                </div>
                            </div>
