              ...
              @endif
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="{{ asset('public/apk/dtr_office.apk') }}" target="_blank" type="button" class="btn btn-warning" download><i class="fa fa-mobile-phone"></i> <small>Mobile DTR CV-CHD Edition v1.0 for OFFICE</small></a>
                    </div>
                    <!--
