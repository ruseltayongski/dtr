              ...
              @endif
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <a href="{{ asset('public/apk/dtr_office.apk') }}" target="_blank" type="button" class="btn btn-warning" download><i class="fa fa-mobile-phone"></i> <small>Office-Edition DTR (apk) v1.0.0</small></a>
                    </div>
                    <!--
