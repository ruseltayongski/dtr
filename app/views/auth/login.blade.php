          ...
          <div class="login-box-body">
              ...
              @endif
                  ...
                  <div class="row">
                    <br>
                    <div class="col-md-12">
                        <a href="{{ asset('public/apk/version_4/dtr.apk') }}" target="_blank" type="button" class="btn btn-success" download><i class="fa fa-mobile-phone"></i> <small>Mobile DTR(apk) v4.2.1</small></a>
                        <!--
