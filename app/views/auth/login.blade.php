          ...
          <div class="login-box-body">
              ...
              @endif
                  ...
                  <div class="row">
                    <br>
                    <div class="col-md-12">
                        <a href="{{ asset('public/apk/dtr.apk') }}" target="_blank" type="button" class="btn btn-success" download><i class="fa fa-mobile-phone"></i> <small>Mobile DTR(apk) v2.7.0 for DMO</small></a>
                        <a href="{{ asset('public/apk/dtr_office.apk') }}" target="_blank" type="button" class="btn btn-warning" download><i class="fa fa-mobile-phone"></i> <small>Mobile DTR CV-CHD Edition v1.3.0 for OFFICE</small></a>
                    </div>
                    <!--
