...
<script>
    ...
    else if(am_out_lat != "null" && am_out_lon != "null" && am_out_lat != "empty" && am_out_lon != "empty"){
        console.log(am_out_lat);
        console.log(am_out_lon);
        mymap = L.map('mapid').setView([am_out_lat, am_out_lon], 25);
    }
    else if(pm_in_lat != "null" && pm_in_lon != "null" && pm_in_lat != "empty" && pm_in_lon != "empty"){
        console.log(pm_in_lat);
        console.log(pm_in_lon);
        mymap = L.map('mapid').setView([pm_in_lat, pm_in_lon], 25);
    }
    else if(pm_out_lat != "null" && pm_out_lon != "null" && pm_out_lat != "empty" && pm_out_lon != "empty"){
