...
@section('js')
    ...
    <script>
        ...
        function displayImage(element, image) {
            ...
            if (size) {
                $('#image_modal').html(
                    '<div class="image-wrapper" style="width: ' + modalWidth + '; height: ' + modalSize + '; display: flex; justify-content: center; align-items: center; overflow: hidden;">' +
                    '<img src="' + image + '" alt="Image" class="img-fluid" style="transform: rotate(' + size + 'deg); object-fit: cover; width: 100%; height: 100%; border: 5px solid white; box-shadow: 0 0px 5px gray;" rotangle="' + size + '">' +
                    '</div>'
                );
            } else {
                $('#image_modal').html(
                    '<div class="image-wrapper" style="width: ' + modalWidth + '; height: ' + modalSize + '; display: flex; justify-content: center; align-items: center; overflow: hidden;">' +
                    '<img src="' + image + '" alt="Image" class="img-fluid" style="object-fit: cover; width: 100%; height: 100%; border: 5px solid white; box-shadow: 0 0px 5px gray;">' +
                    '</div>'
                );
            }
        }
        ...
        //     //         '<img src="' + image + '" alt="Image" class="img-fluid" style="transform: rotate(' + size + 'deg); width: 110%; object-fit: cover; border: 5px solid white; box-shadow: 0 0px 5px gray;" rotangle="' + size + '">' +
        //     //         '</div>'
        //     //     );
        //     // } else {
        //         $('#image_modal').html(
        //             '<div class="image-wrapper" style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center;">' +
        //             '<img src="' + image + '" alt="Image" class="img-fluid" style="width: 110%; object-fit: cover; border: 5px solid white; box-shadow: 0 0px 5px gray;">' +
        //             '</div>'
        //         );
        //     // }
        // }
