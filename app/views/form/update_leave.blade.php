...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <form action="{{ asset('leave/update/save') }}" method="POST" style="margin-top: 1px;margin-left: 50px; margin-right: 40px">
                                                ...
                                                <div class="has-success1">
                                                    <div class="checkbox" style="">
                                                        ...
                                                        <label style="display: inline-block; width: 100%;">
                                                            ...
                                                            <input type="text" name="for_text_input" class="vac_dis" id="abroad_txt" style="margin-left: 2%; width: 70.5%; border: none; border-bottom: 2px solid black;"  value="{{($leave->leave_details == 2)?$leave->leave_specify :''}}"/>
                                                        </label> <br>
                                                        ...
                                                        <label style="display: inline-block; width: 100%;">
                                                            ...
                                                            <input type="text"  name="for_text_input" class="sick_dis" id="in_hos_txt" style="margin-left: 2%; width: 56.6%; border: none; border-bottom: 2px solid black;" value="{{($leave->leave_details == 3)?$leave->leave_specify :''}}" >
                                                        </label>
                                                        <label style="display: inline-block; width: 100%;">
                                                            ...
                                                            <input type="text" name="for_text_input" class="sick_dis" id="out_hos_txt" style="margin-left: 1%; width: 56.6%; border: none; border-bottom: 2px solid black;" value="{{($leave->leave_details == 4)?$leave->leave_specify :''}}">
                                                        </label><br>
                                                        ...
                                                        <label style="display: inline-block; width: 100%;">
                                                            ...
                                                            <input type="text"  name="for_text_input" class="spec_dis" id="spec_txt" style="margin-left: 2%; width: 71.8%; border: none; border-bottom: 2px solid black;" value="{{($leave->leave_details == 5)?$leave->leave_specify :''}}">
                                                        </label><br>
                                    ...
                                    @foreach($leave_dates as $dates)
                                        <strong style="margin-left: 1%">
                                            <div class="table-data" id="clone_data">
                                                <div class="input-group" style="margin-left:5%; margin-bottom: 8px" >
                                                    ...
                                                    <button style="width: 11.5%; margin-left: 12.5%" type="button" class="btn btn-sm btn-danger deleteButton1"><strong>-</strong></button>
                                                </div>
                                            </div>
                                        </strong>
                                    @endforeach
