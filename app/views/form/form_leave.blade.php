                                                ...
                                                <div class="has-success">
                                                    <div class="checkbox">
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="text"  name="for_text_input" class="sick_dis" id="in_hos_txt" style="margin-left: 30px; width: 310px" >
                                                        </label>
                                                        <label>
                                                            <input type="radio" id="checkboxSuccess" class="sick_dis" value="4" name="leave_details"> Out-patient (Specify Illness)
                                                            <input type="text" name="for_text_input" class="sick_dis" id="out_hos_txt" style="margin-left: 26px; width: 310px" >
                                                        </label><br>
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="text"  name="for_text_input" class="spec_dis" id="spec_txt" style="margin-left: 98px; width: 305px" >
                                                        </label><br>
                                                        ...
                                                        <label>
                                                            ...
                                                            <input type="text"  name="for_text_input" class="stud_dis" id="master_txt" style="margin-left: 13px; width: 305px" />
                                                        </label>
                                                        <label>
                                                            <input type="radio" id="checkboxSuccess" class="stud_dis" value="7" name="leave_details"> BAR/Board Examination Review
                                                            <input type="text" name="for_text_input" class="stud_dis" id="bar_txt" style="margin-left: 8px; width: 305px" />
                                                        </label><br>
