...
<div class="container">
    <br>
    <div class="box" style="height: 43%; border: 1px solid black">
    ...
    <br>
    <div class="green-box" style="height: 47%;">
        <table width="100%" style="border: 1px solid black; border-collapse: collapse; text-align: center">
            <tr style="font-weight: bold;">
                <td style="border: 1.5px solid black;border-bottom: none; align-items: center; width: 30%; padding:7px">No. Of Hours Earned/Beginning Balance</td>
            ...
            <tr style="">
                <td style="border: 1.5px solid black;border-bottom: none; align-items: center; width: 25%; height:300px; vertical-align: top">
                    @foreach($card as $row)
                        <table width="100%">
                            <tr style="text-align: left">
                                <td style="width:30%">{{ $row['ot_hours'].' hrs' }}</td>
                                <td style="width:5%">x</td>
                                <td style="width:25%">{{ $row['ot_rate'] }}</td>
                                <td style="width:5%">=</td>
                                <td style="width:35%">{{ $row['ot_credits'].' hrs' }}</td>

                            </tr>
                        </table>
                    @endforeach
                    <span style="border-bottom: 2px solid black; margin-left: 25px">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </span><br>
                     <span style="margin-left: 40px">{{ $sum.' hrs' }} {{ $sum >40 ? '=> 40 hrs' : '' }}</span>

                </td>
                <td style="border: 1.5px solid black; width: 25%; vertical-align: top; text-align: left; padding: 5px">
                    @foreach($card as $row)
                        {{ date('F j, Y', strtotime($row->ot_date)) }}
                    @endforeach
                </td>
                <td style="border: 1.5px solid black; width: 15%"></td>
                <td style="border: 1.5px solid black; width: 20%"></td>
                <td style="border: 1.5px solid black; width: 15%"></td>
            </tr>
        </table>
        <div style="margin-top: 5px">
            ...
            <div class="green-box" style="text-align: right; font-size: 12px; margin-top: 10px">
                DOHRO7-MSDPS-SOP-05-Form2 Rev 0
            </div>
        </div>
    </div>
