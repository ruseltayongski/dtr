    ...
    <div class="new-times-roman" style="margin-top:<?php if($i == 1) echo '4%'; else echo '0%'; ?>">
        ...
        <table width="100%">
            <tr>
                ...
                <td class="align">
                    <table width="100%">
                        <tr><td class="align"><u>&nbsp;&nbsp;{{ $data['section_head'][0]['fname'].' '.$data['section_head'][0]['mname'].' '.$data['section_head'][0]['lname'] }}&nbsp;&nbsp;</u></td></tr>
                        <tr><td class="align">Immediate Supervisor</td></tr>
                        <tr><td class="align"><br><u>&nbsp;&nbsp;{{ $data['division_head'][0]['fname'].' '.$data['division_head'][0]['mname'].' '.$data['division_head'][0]['lname'] }}&nbsp;&nbsp;</u></td></tr>
