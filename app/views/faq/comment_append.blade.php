...
<div class="collapse" id="collapse{{ $comment_id }}">
    <div class="box-footer" style="margin-left:5%;">
        <form action="#" method="post" class="submit_reply_append{{ $comment_id }}" autocomplete="off">
            <img class="img-responsive img-circle img-sm" src="{{ isset($commentUser->picture) ? str_replace('dtr','pis',asset('')).'public/upload_picture/picture/'.$commentUser->picture : str_replace('dtr','pis',asset('')).'public/upload_picture/picture/uknown.png' }}" alt="Alt Text">
