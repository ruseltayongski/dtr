...
<script>
    $("a[href='#modal_tardiness']").on('click',function(){
        $('.modal-title').html('TARDINESS');
        var url = $(this).data('link');
        $('.tardiness-body').html(loadingState);
        setTimeout(function(){
            $.ajax({
                url: url,
                type: 'GET',
                success: function(data) {
                    $('.tardiness-body').html(data);
                    $('.tardiness_picker').daterangepicker();
